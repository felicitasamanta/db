...
$stm = $db->prepare("SELECT * FROM employees WHERE position_id=?");
$stm->execute([$_GET['id']]);
...
<head>
    ...
    <title>Employees by position</title>
...
<div class="mt-5 col-sm-12 col-md-12 col-lg-12 mb-3">
    <div class="card">
        <div class="card-header fw-bold bg-primary">Employees List By Position</div>
        <div class="card-body">
            <a href="index.php" class="btn btn-success float-end">All employees</a>
